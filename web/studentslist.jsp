...
<%@ page import="com.mahan.UI.Model.Degree" %>
<%@ page import="com.mahan.UI.Model.Gender" %>
        ...
        <c:forEach var="student" items="${students}">
            <tr>
                ...
                <td>
                    ...
                    <a href="/admin/student/edit/${student.dId}"> <button>Edit</button></a>


                </td>
                <td>

                    <a href="/admin/student/delete/${student.dId}"><button>Delete</button></a>

...
<%@ page import="com.mahan.UI.Model.Student" %>
<%--
            ...
            <div class="col-sm-offset-1">
                <form action="/createbean.jsp" class="form-horizontal" style="margin-top: 20%" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="firstname" value="${students[studentOrder].firstname}" class="col-sm-3" name="firstname">
                        <label for="lastname" class="col-sm-2">Last Name</label>
                        <input type="text" id="lastname" value="${students[studentOrder].lastname}" class="col-sm-3" name="lastname">
                    </div>
                    <div class="form-group">
                        <label for="NationalNo" class="col-sm-2">National Number</label>
                        <input type="text" id="NationalNo" value="${students[studentOrder].nationalNo}" class="col-sm-3" name="nationalNo">
                        <label class="col-sm-2">Birth Date</label>
                        <input type="text" id="BirthDate" value="${students[studentOrder].birthDate}" class="col-sm-3" name="birthDate">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="studentid" value="${students[studentOrder].studentNo}" class="col-sm-3" name="studentNo">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="${students[studentOrder].email}" id="email" class="col-sm-3" name="email">
                        <label for="phone" class="col-sm-2">Phone</label>
                        <input type="text" value="${students[studentOrder].tel}" id="phone" class="col-sm-3" name="tel">
                    </div>

                    <div class="form-group">
                        <label for="address" class="col-sm-2">Address</label>
                        <input type="text" value="${students[studentOrder].address}" id="address" class="col-sm-8" name="address">
                    </div>
